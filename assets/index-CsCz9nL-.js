...
`,H=({items:s,loading:n,saving:a,onSubmit:r})=>{const[c,u]=l.useState({}),[p,d]=l.useState({});l.useEffect(()=>{if(!n){const t={};s.forEach(i=>{t[i.key]=i.value}),u(t),d({})}},[n]);const h=(t,i)=>{u(_=>({..._,[t]:i})),p[t]&&d(_=>({..._,[t]:void 0}))},x=()=>{const t={};return s.forEach(i=>{c[i.key]?.trim()||(t[i.key]="กรุณาเลือกวันที่")}),d(t),Object.keys(t).length===0},o=async()=>{if(!x())return;const t={items:s.map(i=>({...i,value:c[i.key]??i.value}))};await r(t)};return n?e.jsxs("div",{className:"tt-panel tt-panel--responsive",children:[e.jsx("style",{children:w}),e.jsx("div",{className:"tt-panel-body",children:[0,1,2,3].map(t=>e.jsxs("div",{className:"tt-row",children:[e.jsxs("div",{className:"tt-row-main",children:[e.jsx(m,{height:38,width:38,circle:!0}),e.jsx(m,{height:14,width:"70%"})]}),e.jsx("div",{className:"tt-row-input-col",children:e.jsx(m,{height:34,width:"100%"})})]},t))}),e.jsx("div",{className:"tt-panel-footer",children:e.jsx(m,{height:42,width:110})})]}):e.jsxs("div",{className:"tt-panel tt-panel--responsive",children:[e.jsx("style",{children:w}),e.jsx("div",{className:"tt-panel-body",children:s.map(t=>e.jsxs("div",{className:"tt-row",children:[e.jsxs("div",{className:"tt-row-main",children:[e.jsx("div",{className:"tt-row-icon",children:e.jsx("i",{className:L[t.key]??"ri-calendar-line"})}),e.jsxs("div",{children:[e.jsx("div",{className:"tt-row-label",children:t.label}),f[t.key]&&e.jsx("div",{className:"tt-row-desc",children:f[t.key]})]})]}),e.jsxs("div",{className:"tt-row-input-col",children:[e.jsx("div",{className:"tt-input-wrap",children:e.jsx(b,{value:c[t.key]??"",options:F,hasError:!!p[t.key],placeholder:"เลือกวันที่...",onChange:i=>h(t.key,i)})}),p[t.key]&&e.jsx("span",{className:"tt-row-error",children:p[t.key]})]})]},t.key))}),e.jsx("div",{className:"tt-panel-footer",children:e.jsx(j,{variant:"primary",size:"lg",leftIcon:"ri-save-3-line",loading:a,disabled:a,onClick:()=>{o()},children:"บันทึก"})})]})},X=()=>{l.useEffect(()=>{document.title="วันที่ตรวจอุปกรณ์ | Settings Safety Equipment"},[]);const{saving:s,saveCheckDay:n}=K(),[a,r]=l.useState([]),[c,u]=l.useState(!0),[p,d]=l.useState(null),h=l.useCallback(async()=>{u(!0),d(null);try{const o=await D.list();r(o)}catch(o){d(o instanceof Error?o.message:"เกิดข้อผิดพลาด")}finally{u(!1)}},[]);l.useEffect(()=>{h()},[h]);const x=l.useCallback(async o=>{try{await n(o),h()}catch{}},[n,h]);return p&&a.length===0?e.jsx("div",{className:"page-content",children:e.jsxs(E,{fluid:!0,children:[e.jsx(A,{title:"ตั้งค่าวันที่",pageTitle:"Settings"}),e.jsx("div",{className:"outer-wrapper"})]})}):e.jsxs("div",{className:"page-content",children:[e.jsxs(E,{fluid:!0,children:[e.jsx(A,{title:"ตั้งค่าวันที่",pageTitle:"Settings"}),e.jsx("div",{className:"outer-wrapper",children:e.jsx(T,{children:e.jsx(S,{children:e.jsx(H,{items:a,loading:c,saving:s,onSubmit:x})})})})]}),e.jsx(Y,{}),e.jsx(N,{})]})};export{X as default};
