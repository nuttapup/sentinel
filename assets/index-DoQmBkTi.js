...
{/* disabled */}
<Switch checked disabled label="ปิดใช้งาน" />`,We={fontFamily:"var(--font-body)",fontSize:10,fontWeight:800,letterSpacing:".14em",textTransform:"uppercase",color:"var(--color-text-subtle)",marginBottom:"var(--space-3)"},Nl={background:"var(--color-surface-white)",border:"1px solid var(--color-border-default)",borderRadius:"var(--radius-md)",padding:"var(--space-5)",boxShadow:"var(--shadow-card)",maxWidth:420},Tl={display:"flex",alignItems:"center",justifyContent:"space-between",gap:"var(--space-4)",padding:"var(--space-3) 0",borderBottom:"1px solid var(--color-border-default)"},ce=({label:i,defaultOn:s=!1,size:l="md"})=>{const[n,r]=o.useState(s);return e.jsxs("div",{style:Tl,children:[e.jsx("span",{style:{fontSize:13,color:"var(--color-text-body)",fontWeight:500},children:i}),e.jsx(R,{checked:n,onChange:r,size:l})]})},zl=()=>{const[i,s]=o.useState(!0);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-7)"},children:[e.jsxs("div",{children:[e.jsx("div",{style:We,children:"Sizes & States"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-6)",flexWrap:"wrap",alignItems:"center"},children:[e.jsx(R,{defaultChecked:!0,label:"md (default)"}),e.jsx(R,{size:"sm",defaultChecked:!0,label:"sm"}),e.jsx(R,{disabled:!0,label:"disabled off"}),e.jsx(R,{checked:!0,onChange:()=>{},disabled:!0,label:"disabled on"}),e.jsx(R,{})]})]}),e.jsxs("div",{children:[e.jsx("div",{style:We,children:"Settings Panel"}),e.jsxs("div",{style:Nl,children:[e.jsx("div",{style:{fontSize:13,fontWeight:700,color:"var(--color-text-heading)",marginBottom:"var(--space-3)"},children:"การตั้งค่าการแจ้งเตือน"}),e.jsx(ce,{label:"แจ้งเตือนทาง Email",defaultOn:!0}),e.jsx(ce,{label:"แจ้งเตือนใน App",defaultOn:!0}),e.jsx(ce,{label:"แจ้งเตือน SMS",defaultOn:!1}),e.jsx(ce,{label:"รายงานรายสัปดาห์",defaultOn:!0,size:"sm"}),e.jsx(ce,{label:"แสดงในปฏิทินสาธารณะ",defaultOn:!1,size:"sm"})]})]}),e.jsxs("div",{children:[e.jsx("div",{style:We,children:"Status Toggle"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-4)",alignItems:"center",flexWrap:"wrap"},children:[e.jsx(E,{variant:i?"success":"neutral",style:{cursor:"pointer",userSelect:"none"},onClick:()=>s(l=>!l),children:i?"ใช้งาน":"ปิดใช้งาน"}),e.jsx(R,{checked:i,onChange:s}),e.jsx("span",{style:{fontSize:12,color:"var(--color-text-muted)"},children:"คลิก badge หรือ switch เพื่อสลับสถานะ"})]})]})]})},Fl=`import Modal, { ModalRowDouble, ModalRow } from '@/components/common/Modal';
import Button from '@/components/common/Button';
...
`,ls=[{title:"1. Buttons — ปุ่มทุก variant",code:Ji,node:e.jsx(el,{})},{title:"2. Badges — ป้ายสถานะ",code:il,node:e.jsx(ll,{})},{title:"3. Summary Cards — การ์ดสรุปตัวเลข",code:sl,node:e.jsx(nl,{})},{title:"4. Data Table — ตารางข้อมูล + pagination",code:rl,node:e.jsx(dl,{})},{title:"5. Tabs — Underline / Segmented / Pill",code:cl,node:e.jsx(hl,{})},{title:"6. Form Inputs — ฟอร์มกรอกข้อมูล",code:ul,node:e.jsx(bl,{})},{title:"7. Radio & Checkbox",code:yl,node:e.jsx(Sl,{})},{title:"8. Status Toggle — Active / Inactive",code:Cl,node:e.jsx(kl,{})},{title:"9. Switch & Toggle",code:wl,node:e.jsx(zl,{})},{title:"10. Modal — Add / Edit / Confirm / Success",code:Fl,node:e.jsx(Bl,{})},{title:"11. Toast — การแจ้งเตือน",code:Pl,node:e.jsx(Dl,{})},{title:"12. Tooltip & Popover",code:Rl,node:e.jsx(Wl,{})},{title:"13. Avatar & User Chip",code:Ll,node:e.jsx(Ol,{})},{title:"14. Progress & Stepper",code:Ml,node:e.jsx(Ul,{})},{title:"15. Empty State / Spinner / Skeleton",code:Gl,node:e.jsx(Vl,{})},{title:"16. Events State — 404 / 500 / Empty / 403",code:gi,node:e.jsx(ql,{})},{title:"17. File Upload",code:Xl,node:e.jsx(es,{})}],Cs=()=>(o.useEffect(()=>{document.title="Examples — Sentinel DS"},[]),e.jsxs(Oe.Fragment,{children:[e.jsx("style",{children:is}),e.jsx("div",{className:"page-content",children:e.jsxs(Ei,{fluid:!0,children:[e.jsx(Li,{title:"Examples Components",pageTitle:"Sentinel Design System"}),e.jsx("div",{className:"outer-wrapper",children:ls.map(({title:i,code:s,node:l})=>e.jsx(Di,{className:"mb-3",children:e.jsx(Ri,{lg:12,children:e.jsxs(Ai,{children:[e.jsx(Qi,{title:i,code:s}),e.jsx(Wi,{children:l})]})})},i))})]})})]}));export{Cs as default};
